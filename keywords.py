...
def generateCandidateKeywords(text, stopwords, lemmatizer = None):
	'''
...
def getKeyPhrases(text, stopwords, lemmatizer = None):
	'''
	Getting keywords phrases, generated by RAKE Score Algorythm
	'''
	if (lemmatizer == None):
		candidates = generateCandidateKeywords(text, stopwords)
	else:
		candidates = generateCandidateKeywords(text, stopwords, lemmatizer)
