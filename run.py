...
class file:
	...
	def hash(self):
		...
		self.hash = md5sum_file(self.path_txt)
...
if __name__ == "__main__":
	...
	end_time = time()
	print("Searching in Google took {0:.3f}".format(end_time - start_time), end = "\n\n")
	...
	for url in urls:
		try:
			...
			path_pdf = download(url, directory = "./TMP")
			...
			continue
	end_time = time()
	print("Download is complete and took {0:.3f}".format(end_time - start_time), end = "\n\n")
